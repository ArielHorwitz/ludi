...
class UnitSprite(kx.XAnchor):
    def __init__(self, player_index: int, unit_index: int):
        ...
        self.color = PLAYER_COLORS[self.player_index]
        self.make_bg(self.color, ASSET_DIR / "unit.png")
        self.pulse = Animation(self._pulse, Interp.pulse, speed=3, guarantee_last=1)
    ...
    def fade_finish(self):
        self.make_bg(kx.XColor.white().modified_value(0.5))
